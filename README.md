...
### In progress / next
- **Demo page + invite system** — public demo with guided tour, read-only seed data, invite-code gated registration, and request-access flow; see [`docs/DEMO_PLAN.md`](docs/DEMO_PLAN.md)
- **OKR alignment tree** — company-level visual showing how team OKRs roll up to org goals
- **AI writing assistance** — per-KR and per-objective critique with rewrite suggestions; see [`docs/AI_OKR_HELPER.md`](docs/AI_OKR_HELPER.md)
